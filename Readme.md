...
1. Pick the **N. California** region in the drop-down in the upper right of the console
    1. ![](instruction-images/region-sfo.png)
...
1. Under the Log In dropdown on the top right of the page choose **GCP-US-West** under **Sysdig Secure** (NOTE: not Sysdig Monitor which we won't be looking at today)
    1. ![](instruction-images/sysdiglogin-sfo.png)
...
**./sysdig-cli-scanner -a https://app.us4.sysdig.com logstash:7.16.1**
...
```
./sysdig-cli-scanner --apiurl https://app.us4.sysdig.com --iac example-scenarios/k8s-manifests/04-security-playground-deployment.yaml
```
