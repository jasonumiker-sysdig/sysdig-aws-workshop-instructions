...
1. Pick the **Oregon** region in the drop-down in the upper right of the console
    1. ![](instruction-images/region-pdx.png)
...
1. Under the Log In dropdown on the top right of the page choose **US-West** under **Sysdig Secure** (NOTE: not Sysdig Monitor which we won't be looking at today)
    1. ![](instruction-images/sysdiglogin-pdx.png)
...
**./sysdig-cli-scanner -a https://us2.app.sysdig.com logstash:7.16.1**
...
```
./sysdig-cli-scanner --apiurl https://us2.app.sysdig.com --iac example-scenarios/k8s-manifests/04-security-playground-deployment.yaml
```
